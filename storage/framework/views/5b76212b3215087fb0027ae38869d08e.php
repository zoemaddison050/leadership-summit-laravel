<?php $__env->startSection('title', 'International Global Leadership Academy Summit 2025'); ?>
<?php $__env->startSection('meta_description', 'Join us for the exclusive International Global Leadership Academy Summit in September 2025, Cypress. Connect with global leaders and visionaries to shape the future of leadership.'); ?>
<?php $__env->startSection('meta_keywords', 'leadership summit, global leadership, academy, conference, professional development, networking, speakers, events'); ?>
    ...
    <div class="container">
        <div class="hero-content text-center">
            ...
            <div class="hero-cta">
                ...
                ?>
                <?php if($defaultEvent): ?>
                <a href="<?php echo e(route('events.show', $defaultEvent->slug)); ?>" class="btn btn-secondary btn-lg">
                    <i class="fas fa-ticket-alt me-2" aria-hidden="true"></i>Register Now
                </a>
                <?php endif; ?>
                <a href="<?php echo e(url('/about')); ?>" class="btn btn-outline-light btn-lg">
...
<section class="events-section">
    <div class="container">
        ...
        <div class="events-grid">
            ...
            <div class="event-card">
                <div class="event-image">
                    ...
                    <img src="<?php echo e(asset('storage/' . $event->featured_image)); ?>" alt="<?php echo e($event->title); ?>" class="w-100 h-100" style="object-fit: cover;">
                    <?php else: ?>
            ...
            <div class="event-card">
                ...
                <div class="event-content">
                    ...
                    <a href="<?php echo e(url('/events')); ?>" class="btn btn-primary">
                        Learn More <i class="fas fa-arrow-right ms-1" aria-hidden="true"></i>
                    </a>
                </div>
            </div>
        ...
        <div class="text-center mt-4">
            <a href="<?php echo e(url('/events')); ?>" class="btn btn-outline-primary btn-lg">
...
<section class="cta-section">
    <div class="container">
        ...
        <div class="d-flex justify-content-center gap-3 flex-wrap">
            ...
            <?php endif; ?>
            <a href="<?php echo e(url('/speakers')); ?>" class="btn btn-outline-light btn-lg">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/Apple/Desktop/dev_folder/Dev_project/test.kiro2/leadership-summit-laravel/resources/views/home.blade.php ENDPATH**/ ?>