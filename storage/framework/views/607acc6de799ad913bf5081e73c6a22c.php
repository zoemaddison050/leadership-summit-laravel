<?php $__env->startSection('title', 'Speakers - Leadership Summit 2025'); ?>
<?php $__env->startSection('meta_description', 'Meet our world-class speakers at the International Global Leadership Academy Summit 2025. Industry leaders, innovators, and visionaries.'); ?>
...
<section class="featured-speakers">
    <div class="container">
        ...
        <div class="featured-grid">
            <?php if(isset($featuredSpeakers) && $featuredSpeakers->count() > 0): ?>
            <?php $__currentLoopData = $featuredSpeakers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $speaker): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="featured-speaker-card">
                ...
                <div class="featured-speaker-info">
                    <h3><?php echo e($speaker->name); ?></h3>
                    <p class="speaker-title"><?php echo e($speaker->position); ?></p>
                    <?php if($speaker->company): ?>
                    <p class="speaker-company"><?php echo e($speaker->company); ?></p>
                    <?php endif; ?>
                    <p class="speaker-bio"><?php echo e(Str::limit($speaker->bio, 120)); ?></p>
                    <a href="<?php echo e(url('/speakers/' . $speaker->id)); ?>" class="btn btn-primary">
                        View Profile
                    </a>
                </div>
            </div>
...
<section class="speakers-filters">
    <div class="container">
        <div class="filter-tabs">
            <a href="<?php echo e(url('/speakers')); ?>" class="filter-tab <?php echo e(!request('category') ? 'active' : ''); ?>">
                All Speakers
            </a>
            <a href="<?php echo e(url('/speakers?category=ceo')); ?>" class="filter-tab <?php echo e(request('category') == 'ceo' ? 'active' : ''); ?>">
                CEOs & Executives
            </a>
            <a href="<?php echo e(url('/speakers?category=entrepreneur')); ?>" class="filter-tab <?php echo e(request('category') == 'entrepreneur' ? 'active' : ''); ?>">
                Entrepreneurs
            </a>
            <a href="<?php echo e(url('/speakers?category=academic')); ?>" class="filter-tab <?php echo e(request('category') == 'academic' ? 'active' : ''); ?>">
                Academics
            </a>
            <a href="<?php echo e(url('/speakers?category=consultant')); ?>" class="filter-tab <?php echo e(request('category') == 'consultant' ? 'active' : ''); ?>">
                Consultants
            </a>
        </div>
...
<section class="speakers-content">
    <div class="container">
        ...
        <?php if(isset($speakers) && $speakers->count() > 0): ?>
            ...
            <div class="speakers-grid">
                ...
                <article class="speaker-card">
                    ...
                    <div class="speaker-content">
                        ...
                        <p class="speaker-bio"><?php echo e(Str::limit(strip_tags($speaker->bio), 100)); ?></p>

                        <?php if(isset($speaker->topics)): ?>
                        <div class="speaker-topics">
                            <?php $__currentLoopData = explode(',', $speaker->topics); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $topic): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <div id="defaultSpeakersGrid">
            <div class="speakers-grid">
                <?php for($i = 1; $i <= 6; $i++): ?>
                    ...
                    <div class="speaker-content">
                        <h2 class="speaker-name">Speaker <?php echo e($i); ?></h2>
                        <p class="speaker-title"><?php echo e(['CEO', 'Founder', 'Director', 'President', 'VP'][($i-1) % 5]); ?></p>
                        <p class="speaker-company"><?php echo e(['Innovation Corp', 'Tech Solutions', 'Global Ventures', 'Future Systems', 'Leadership Inc'][($i-1) % 5]); ?></p>
