<?php $__env->startSection('title', 'Choose Payment Method - ' . $event->title); ?>
...
<div class="payment-selection-container">
    <div class="container">
        <div class="payment-card">
            <a href="<?php echo e(route('events.show', $event)); ?>" class="back-link">
            ...
            <div class="order-summary">
                ...
                <?php if($registrationData['attendee_phone']): ?>
                <div class="summary-item">
                    <div>
                ...
                <?php if(isset($registrationData['emergency_contact_name']) && $registrationData['emergency_contact_name']): ?>
                <div class="summary-item">
                    <div>
                        <div><strong>Emergency Contact:</strong> <?php echo e($registrationData['emergency_contact_name']); ?></div>
                        <?php if(isset($registrationData['emergency_contact_phone']) && $registrationData['emergency_contact_phone']): ?>
                ...
                <?php if(isset($registrationData['ticket_selections'])): ?>
            ...
            <div class="payment-methods">
                <!-- Card Payment Option -->
                <div class="payment-method card <?php echo e($paymentOptions['card']['available'] ? 'available' : 'unavailable'); ?>">
                    <i class="payment-icon fas fa-credit-card"></i>
                    <h3 class="payment-title"><?php echo e($paymentOptions['card']['name']); ?></h3>
                    <p class="payment-description"><?php echo e($paymentOptions['card']['description']); ?></p>

                    <ul class="payment-features">
                        <li>
                            <i class="fas <?php echo e($paymentOptions['card']['available'] ? 'fa-check' : 'fa-times'); ?>"></i>
                            <?php echo e($paymentOptions['card']['processing_time']); ?>

                        </li>
                        <?php if($paymentOptions['card']['available']): ?>
                        <li>
                    ...
                    <?php if($paymentOptions['card']['available']): ?>
                    <?php if(isset($paymentOptions['card']['fee_info']) && $paymentOptions['card']['fee_info'] !== 'No processing fees'): ?>
                    <div class="fee-info">
                        <i class="fas fa-info-circle"></i>
                        <?php echo e($paymentOptions['card']['fee_info']); ?>
                    ...
                    <form method="POST" action="<?php echo e(route('payment.card', $event)); ?>">
                        <?php echo csrf_field(); ?>
                ...
                <div class="payment-method crypto <?php echo e($paymentOptions['crypto']['available'] ? 'available' : 'unavailable'); ?>">
                    <i class="payment-icon fas fa-coins"></i>
                    <h3 class="payment-title"><?php echo e($paymentOptions['crypto']['name']); ?></h3>
                    <p class="payment-description"><?php echo e($paymentOptions['crypto']['description']); ?></p>

                    <ul class="payment-features">
                        <li>
                            <i class="fas <?php echo e($paymentOptions['crypto']['available'] ? 'fa-check' : 'fa-times'); ?>"></i>
                            <?php echo e($paymentOptions['crypto']['processing_time']); ?>

                        </li>
                        <?php if($paymentOptions['crypto']['available']): ?>
                        <li>
                    ...
                    <div class="fee-info no-fee">
                        <i class="fas fa-check-circle"></i>
                        <?php echo e($paymentOptions['crypto']['fee_info']); ?>

                    </div>

                    <a href="<?php echo e(route('payment.crypto', $event)); ?>" class="payment-button" style="display: inline-block; text-decoration: none; text-align: center;">
...
<script>
    let registrationExpiresAt = <?php echo json_encode($registrationData['expires_at'] ?? null, 15, 512) ?>;
    ...
    function switchPaymentMethod(newMethod) {
        ...
        switchForm.action = '<?php echo e(route("payment.switch", $event)); ?>';
    ...
    function startRegistrationExpiryCountdown() {
        ...
        const countdownInterval = setInterval(() => {
            ...
            if (timeLeft <= 0) {
                ...
                setTimeout(() => {
                    window.location.href = '<?php echo e(route("events.show", $event)); ?>';
                }, 2000);
                return;
            }
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/Apple/Desktop/dev_folder/Dev_project/test.kiro2/leadership-summit-laravel/resources/views/payments/selection.blade.php ENDPATH**/ ?>