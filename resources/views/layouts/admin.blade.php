...
<head>
    ...
    <!-- SEO Meta Tags -->
    <title>@yield('title', 'Admin Dashboard') - {{ config('app.name', 'Leadership Summit') }}</title>
    <meta name="description" content="Admin dashboard for {{ config('app.name', 'Leadership Summit') }}">
        ...
        <aside class="admin-sidebar" id="adminSidebar">
            ...
            <nav class="sidebar-nav">
                ...
                <div class="nav-section">
                    ...
                    <div class="nav-item">
                        <a href="{{ url('/admin/speakers') }}" class="nav-link {{ request()->is('admin/speakers*') ? 'active' : '' }}">
                            <i class="fas fa-users" aria-hidden="true"></i>
                            All Speakers
                        </a>
                    </div>
                    <div class="nav-item">
                        <a href="{{ url('/admin/speakers/create') }}" class="nav-link {{ request()->is('admin/speakers/create') ? 'active' : '' }}">
                            <i class="fas fa-user-plus" aria-hidden="true"></i>
                            Add Speaker
                        </a>
                    </div>
                    <div class="nav-item">
                        <a href="{{ url('/admin/sessions') }}" class="nav-link {{ request()->is('admin/sessions*') ? 'active' : '' }}">
                ...
                <div class="nav-section">
                    ...
                    <div class="nav-item">
                        <a href="{{ url('/admin/registrations') }}" class="nav-link {{ request()->is('admin/registrations*') ? 'active' : '' }}">
                            ...
                            Registrations
                            @if(isset($newRegistrationsCount) && $newRegistrationsCount > 0)
                            <span class="nav-badge">{{ $newRegistrationsCount }}</span>
                            @endif
                        </a>
                    </div>
                    <div class="nav-item">
                        <a href="{{ url('/admin/payments/pending') }}" class="nav-link {{ request()->is('admin/payments*') ? 'active' : '' }}">
                            <i class="fas fa-credit-card" aria-hidden="true"></i>
                            Payment Review
                            @if(isset($pendingPaymentsCount) && $pendingPaymentsCount > 0)
                            <span class="nav-badge">{{ $pendingPaymentsCount }}</span>
                            @endif
                        </a>
                    </div>
                    <div class="nav-item">
                ...
                <div class="nav-section">
                    ...
                    <div class="nav-item">
                        <a href="{{ url('/admin/unipayment') }}" class="nav-link {{ request()->is('admin/unipayment*') ? 'active' : '' }}">
                            <i class="fas fa-credit-card" aria-hidden="true"></i>
                            Card Payments
                        </a>
                    </div>
                    <div class="nav-item">
                        <a href="{{ url('/admin/wallet-settings') }}" class="nav-link {{ request()->is('admin/wallet-settings*') ? 'active' : '' }}">
