...
@section('title', 'UniPayment Settings')
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <form method="POST" action="{{ route('admin.unipayment.update') }}" id="unipayment-form">
                    @csrf
                    @method('PATCH')
                                ...
                                <div class="form-group">
                                    <div class="custom-control custom-switch mt-4">
                                        <input type="checkbox"
                                            ...
                                            value="1"
                                            {{ old('webhook_enabled', $settings->webhook_enabled ?? true) ? 'checked' : '' }}>
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <p class="card-text">
                                                    <code id="current-webhook-url">{{ $settings && $settings->webhook_url ? $settings->webhook_url : route('payment.unipayment.webhook') }}</code>
                                                </p>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="number"
                                            ...
                                            value="{{ old('processing_fee_percentage', $settings->processing_fee_percentage ?? '2.9') }}"
                                            min="0"
                                            max="100"
                                            step="0.1"
                                            placeholder="2.9">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number"
                                        ...
                                        id="minimum_amount"
                                        name="minimum_amount"
                                        value="{{ old('minimum_amount', $settings->minimum_amount ?? '1.00') }}"
                                        min="0"
                                        step="0.01"
                                        placeholder="1.00">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number"
                                        ...
                                        id="maximum_amount"
                                        name="maximum_amount"
                                        value="{{ old('maximum_amount', $settings->maximum_amount ?? '10000.00') }}"
                                        min="0"
                                        step="0.01"
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                        class="form-control @error('supported_currencies') is-invalid @enderror"
                                        id="supported_currencies"
                                        name="supported_currencies"
                                        value="{{ old('supported_currencies', $settings && $settings->supported_currencies ? implode(', ', $settings->supported_currencies) : 'USD') }}"
                            ...
                            <div class="col-md-6">
                                <div class="card bg-light">
                                    <div class="card-body">
                                        ...
                                        <p class="card-text">
                                            <code>{{ route('payment.unipayment.webhook') }}</code>
                                        </p>
                                        <small class="text-muted">
                            ...
                            <div class="col-md-6">
                                <div class="card bg-light">
                                    <div class="card-body">
                                        ...
                                        <p class="card-text">
                                            <code>{{ route('payment.unipayment.callback') }}</code>
                                        </p>
                                        <small class="text-muted">
...
<script>
    $(document).ready(function() {
        ...
        $('#test-connection-btn').click(function() {
            ...
            $.ajax({
                url: '{{ route("admin.unipayment.test-connection") }}',
                method: 'POST',
                data: {
                    app_id: appId,
        ...
        function checkConnectionStatus() {
            $.ajax({
                url: '{{ route("admin.unipayment.connection-status") }}',
                method: 'GET',
                success: function(response) {
        ...
        $('#generate-webhook-url-btn').click(function() {
            ...
            $.ajax({
                url: '{{ route("admin.unipayment.generate-webhook-url") }}',
                method: 'GET',
                success: function(response) {
        ...
        $('#test-webhook-btn').click(function() {
            ...
            $.ajax({
                url: '{{ route("admin.unipayment.test-webhook") }}',
                method: 'POST',
                data: {
        ...
        $('#webhook_url').on('input', function() {
            ...
            if (url) {
                ...
                $('#current-webhook-url').text('{{ route("payment.unipayment.webhook") }}');
            }
        });
        ...
        function checkWebhookStatus() {
            $.ajax({
                url: '{{ route("admin.unipayment.webhook-status") }}',
                method: 'GET',
                success: function(response) {
        ...
        $('#test-accessibility-btn').click(function() {
            ...
            $.post('{{ route("admin.unipayment.test-webhook-accessibility") }}', {
                    _token: '{{ csrf_token() }}',
        ...
        $('#test-payload-btn').click(function() {
            ...
            $.post('{{ route("admin.unipayment.test-webhook-payload") }}', {
                    _token: '{{ csrf_token() }}',
                    webhook_url: $('#webhook_url').val()
                })
                .done(function(response) {
        ...
        $('#run-diagnostics-btn').click(function() {
            ...
            $.get('{{ route("admin.unipayment.webhook-diagnostics") }}')
                .done(function(response) {
        ...
        $('#reset-counters-btn').click(function() {
            ...
            $.post('{{ route("admin.unipayment.reset-webhook-counters") }}', {
                    _token: '{{ csrf_token() }}'
                })
                .done(function(response) {
                    result.html(`
        ...
        $('#clear-cache-btn').click(function() {
            ...
            $.post('{{ route("admin.unipayment.clear-webhook-test-cache") }}', {
                    _token: '{{ csrf_token() }}'
                })
                .done(function(response) {
                    result.html(`
        ...
        function loadWebhookHealth() {
            $.get('{{ route("admin.unipayment.webhook-health") }}')
                .done(function(response) {
        ...
        function loadWebhookMetrics() {
            $.get('{{ route("admin.unipayment.webhook-metrics") }}')
                .done(function(response) {
        ...
        function loadWebhookTrends() {
            $.get('{{ route("admin.unipayment.webhook-trends") }}')
                .done(function(response) {
