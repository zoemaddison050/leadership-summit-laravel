...
<div class="page-header">
    ...
    <div class="page-actions">
        ...
        <a href="{{ url('/admin/speakers/create') }}" class="btn btn-outline-primary">
...
<div class="stats-grid">
    <div class="stat-card">
        ...
        <div class="stat-change {{ ($growth['events_this_month'] ?? 0) > 0 ? 'positive' : 'neutral' }}">
            <i class="fas fa-arrow-up" aria-hidden="true"></i>
            <span>+{{ $growth['events_this_month'] ?? 0 }} this month</span>
        </div>
    </div>
    ...
    <div class="stat-card success">
        ...
        <div class="stat-change {{ ($growth['registrations_this_week'] ?? 0) > 0 ? 'positive' : 'neutral' }}">
            <i class="fas fa-arrow-up" aria-hidden="true"></i>
            <span>+{{ $growth['registrations_this_week'] ?? 0 }} this week</span>
        </div>
    </div>
    ...
    <div class="stat-card warning">
        ...
        <div class="stat-value">{{ $stats['total_speakers'] ?? 0 }}</div>
    ...
    <div class="stat-card danger">
        ...
        <div class="stat-change {{ ($growth['revenue_growth'] ?? 0) > 0 ? 'positive' : (($growth['revenue_growth'] ?? 0) < 0 ? 'negative' : 'neutral') }}">
            <i class="fas fa-{{ ($growth['revenue_growth'] ?? 0) > 0 ? 'arrow-up' : (($growth['revenue_growth'] ?? 0) < 0 ? 'arrow-down' : 'minus') }}" aria-hidden="true"></i>
            <span>{{ ($growth['revenue_growth'] ?? 0) > 0 ? '+' : '' }}{{ $growth['revenue_growth'] ?? 0 }}% vs last month</span>
        </div>
    </div>
</div>
    ...
    <div class="col-lg-8">
        ...
        <div class="admin-card mb-4">
            <div class="admin-card-header">
                ...
                <a href="{{ url('/admin/registrations') }}" class="btn btn-sm btn-outline-primary">View All</a>
            </div>
            <div class="admin-card-body">
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            <div class="fw-semibold">{{ $registration->attendee_name }}</div>
                                ...
                                <td>
                                    <span class="badge bg-{{ $registration->registration_status === 'confirmed' ? 'success' : ($registration->registration_status === 'pending' ? 'warning' : 'secondary') }}">
                ...
                <div class="text-center py-5">
                    ...
                    <a href="{{ route('events.show', \App\Models\Event::first()->slug ?? '#') }}" class="btn btn-primary btn-sm">
        ...
        <div class="admin-card">
            <div class="admin-card-header">
                ...
                <a href="{{ url('/admin/events') }}" class="btn btn-sm btn-outline-primary">Manage Events</a>
            </div>
            <div class="admin-card-body">
                ...
                <div class="d-flex align-items-center p-3 border rounded mb-3">
                    ...
                    <div class="flex-grow-1 ms-3">
                        ...
                        <p class="text-muted mb-1">{{ $event->start_date->format('F d, Y g:i A') }}</p>
                    ...
                    <div class="flex-shrink-0">
                        <a href="{{ url('/admin/events/' . $event->id) }}" class="btn btn-sm btn-outline-primary">
                            Manage
                        </a>
                    </div>
                </div>
        ...
        <div class="admin-card mb-4">
            ...
            <div class="admin-card-body">
                <div class="d-grid gap-2">
                    ...
                    <a href="{{ route('admin.speakers.index') }}" class="btn btn-outline-primary">
                        <i class="fas fa-users me-2" aria-hidden="true"></i>Manage Speakers
                    </a>
                    <a href="{{ route('admin.wallet-settings.index') }}" class="btn btn-outline-success">
                    ...
                    <hr>
                    <a href="{{ route('admin.registrations.index') }}" class="btn btn-outline-info">
                        <i class="fas fa-clipboard-list me-2" aria-hidden="true"></i>Registrations
                    </a>
                    <a href="{{ route('admin.tickets.index') }}" class="btn btn-outline-info">
                    ...
                    <a href="{{ route('admin.reports.index') }}" class="btn btn-outline-dark">
